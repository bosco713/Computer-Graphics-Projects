...
inline void ModelerUserInterface::cb_FrameAll_i(Fl_Menu_*, void*) {
	m_modelerView->m_camera->setElevation(M_PI/4);
	m_modelerView->m_camera->setAzimuth(4.9*M_PI / 4);
	m_modelerView->m_camera->setLookAt(Vec3f(33+VAL(XPOS), 48+VAL(YPOS), 39+VAL(ZPOS)));
	m_modelerView->redraw();
}
...
Fl_Menu_Item* ModelerUserInterface::m_controlsAnimOnMenu = ModelerUserInterface::menu_m_controlsMenuBar + 19; // I change it from 18 to 19 as i added frame all
