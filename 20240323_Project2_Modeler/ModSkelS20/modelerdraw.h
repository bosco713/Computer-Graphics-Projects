...
// Draw a right-angled triangle prism with length, and height of the base triangle, togather with the thickness. The base is laying on the +ve. x,y axis.
void drawRightAngledTrianglePrism(double length, double height, double thickness);

// Draw a torus with radius and the thickness laying on the x,z axis.
